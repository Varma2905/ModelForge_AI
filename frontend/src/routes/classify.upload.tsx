...
import { applyNewClassificationDataset } from "@/lib/apply-new-classification-dataset";
import { requireAuth } from "@/lib/require-auth";
import type { DatasetListItem, DatasetSourceType, DatasetSummary } from "@/lib/api-types";

export const Route = createFileRoute("/classify/upload")({
...
function UploadPage() {
  ...
  const handleNewDataset = (result: DatasetSummary) => {
    ...
    applyNewClassificationDataset(update, {
  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold">Add Dataset for Classification</h1>
        ...
        <UploadInfoCards taskType="classification" />
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    navigate({ to: "/classify/variables" });
                  }}
                >
